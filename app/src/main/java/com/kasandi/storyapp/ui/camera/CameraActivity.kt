package com.kasandi.storyapp.ui.camera
...
import com.kasandi.storyapp.databinding.ActivityCameraBinding
import com.kasandi.storyapp.helper.createCustomTempFile
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(binding.finderCameraPreview.surfaceProvider)
                }
